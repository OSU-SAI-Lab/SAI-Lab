...
export const events = [
  ...
  body: `
    <p>
      Faculty and students from the Systems and AI Lab recently attended in An Evening of Inquiry at the <a href="https://www.columbusschoolforgirls.org/" target="_blank" rel="noopener noreferrer">Columbus School for Girls</a> on April 28, 2026, an event celebrating student‑led research, creativity, and interdisciplinary exploration. This collaboration was carried out under the ambit of the <a href="https://icicle.osu.edu/" target="_blank" rel="noopener noreferrer">ICICLE</a> AI Institute, which supports educational outreach and K–12 engagement in artificial intelligence and computing.
    </p>
    <p>
      The evening featured a vibrant poster session highlighting projects from participants in the <a href="https://www.ai.gov/initiatives/presidential-challenge" target="_blank" rel="noopener noreferrer">Presidential AI Challenge</a>. Several students mentored by our lab presented their work, including Caroline Lanning, Iva Karagirova, Wendy Yi, and Kendall Leff. Their projects reflected a strong engagement with emerging AI concepts and demonstrated thoughtful application of computational methods to real‑world problems, aligned with ICICLE's mission to broaden access to AI education and research.
    </p>
    <p>
      Our lab's involvement was led by graduate student Mrunal Hole, who coordinated mentorship and research support for the school's Presidential AI Challenge participants. Mrunal worked closely with undergraduate researchers Naveen Kamath and Rishi Makineni, who assisted with guidance, project development, and preparation for the poster session, all as part of ICICLE‑supported outreach activities. Their collaboration was supported on‑site by <a href="https://www.linkedin.com/in/lisa-abrams-96aa8560/" target="_blank" rel="noopener noreferrer">Dr. Lisa M. Abrams</a>, PhD, Computer Science and Math Faculty and Dean of Academics for the Upper School at Columbus School for Girls, whose leadership helped foster an inclusive and intellectually engaging environment.
    </p>
    <p>
